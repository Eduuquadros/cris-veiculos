    ...
    <main className="mt-5 mb-10">
      ...
      <div className="mt-8 lg:grid grid-cols-3 gap-6 cursor-pointer">
        {cars
          ...
          .map((car) => (
            <div key={car.id} className="border-b pb-8 mb-8 lg:mb-0">
              <Link href={`/${car.url}`}>
                <div className="rounded border-4 lg:max-h-[260px] overflow-hidden flex items-center justify-center">
                  <Image
                ...
                <div
                  className={`mt-1 text-[#3e9c35] font-bold text-2xl  ${
              ...
              <div className="mt-4 flex items-center justify-between">
                <Link href={`/${car.url}`}>
                  <button className="rounded-full bg-[#25d366] text-white px-8 py-2 text-LG hover:opacity-70">
                    VER DETALHES
                  </button>
                </Link>
                <div>
